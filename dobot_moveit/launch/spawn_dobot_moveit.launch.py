...
def generate_launch_description():
    moveit_config_folder_name = 'dobot_moveit'

    xacro_file = get_package_file(moveit_config_folder_name, 'config/dobot_magician.urdf.xacro')
    urdf_file = run_xacro(xacro_file)
    robot_description_arm = load_file(urdf_file)

    srdf_file = get_package_file(moveit_config_folder_name, 'config/dobot_magician.srdf')
    ...
    rviz_config_file = os.path.join(moveit_config_folder_name, 'rviz/', 'moveit_view.rviz')
